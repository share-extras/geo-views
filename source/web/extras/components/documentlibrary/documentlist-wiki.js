...
(function()
{
   ...
   Extras.DocumentListGeoViewRenderer.prototype.getDataTableRecordIdFromRowElement = function DL_GVR_getDataTableRecordIdFromRowElement(scope, rowElement) //SAME
   {
   ...
   Extras.DocumentListGeoViewRenderer.prototype.getRowElementFromDataTableRecord = function DL_GVR_getRowElementFromDataTableRecord(scope, oRecord) //SAME
   {
      var galleryItemId = this.getRowItemId(oRecord);
      // Yahoo.util.Dom.get does not work here for some reason
   ...
   Extras.DocumentListGeoViewRenderer.prototype.getRowSelectElementFromDataTableRecord = function DL_GVR_getRowSelectElementFromDataTableRecord(scope, oRecord) //SAME
   {
   ...
   // TODO Need destroyView()?
   
   // TODO Need renderCellSelected()?
   
   Extras.DocumentListGeoViewRenderer.prototype.getThumbnail = function DL_GVR_getThumbnail(scope, elCell, oRecord, oColumn, oData, imgIdSuffix, renditionName) // SAME
   {
      if (imgIdSuffix == null)
      {
         imgIdSuffix = "-hidden";
   ...
   Extras.DocumentListGeoViewRenderer.prototype.renderCellStatus = function DL_GVR_renderCellStatus(scope, elCell, oRecord, oColumn, oData) //SAME
   {
   ...
   Extras.DocumentListGeoViewRenderer.prototype.renderCellDescription = function DL_GVR_renderCellDescription(scope, elCell, oRecord, oColumn, oData) //SAME
   {
